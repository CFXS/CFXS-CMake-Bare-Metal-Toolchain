...
SET(CMAKE_ASM_COMPILER tiarmasm)
SET(CMAKE_LINKER tiarmlnk)
...
include_directories(SYSTEM
    "${SYSROOT}/include/armv7em-ti-none-eabihf/c++/v1"
...
set(CMAKE_CXX_FLAGS_DEBUG "-std=c++17 -DDEBUG            -gdwarf${CFXS_COMPILE_DWARF_VERSION} -O0       ${CXX_COMMON_FLAGS}")
set(CMAKE_CXX_FLAGS_RELEASE "-std=c++17 -DNDEBUG -DRELEASE -gdwarf${CFXS_COMPILE_DWARF_VERSION} -Ofast -ffast-math      ${CXX_COMMON_FLAGS}")
set(CMAKE_CXX_FLAGS_MINSIZEREL "-std=c++17 -DNDEBUG -DRELEASE -gdwarf${CFXS_COMPILE_DWARF_VERSION} -Os       ${CXX_COMMON_FLAGS}")
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-std=c++17 -DNDEBUG -DRELEASE -gdwarf${CFXS_COMPILE_DWARF_VERSION} -O2 -Og   ${CXX_COMMON_FLAGS}")
...
set(OBJDUMP tiarmobjdump)
set(SIZE tiarmsize)
set(NM tiarmnm)
set(AR tiarmar)

set(CFXS_COMPILER "TI_ARM_CLANG")